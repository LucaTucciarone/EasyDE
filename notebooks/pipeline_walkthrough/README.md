...
|----------|---------------|-------------|
| [00_setup.Rmd](00_setup.Rmd) | — | Config, libraries, define contrasts and strata loops |
| [01_validate.Rmd](01_validate.Rmd) | Step 01 | Validate config and contrasts |
| [02_prepare_coldata.Rmd](02_prepare_coldata.Rmd) | Step 02 | Filter samples, build coldata, preflight QC |
| [03_deseq_base.Rmd](03_deseq_base.Rmd) | Step 03 | Base DESeq2 analysis |
| [04_ruvseq.Rmd](04_ruvseq.Rmd) | Step 04 | RUVseq normalization (skipped in paired mode) |
| [05_deseq_final.Rmd](05_deseq_final.Rmd) | Step 05 | Final DESeq2 with W factors (skipped in paired mode) |
| [06_fgsea.Rmd](06_fgsea.Rmd) | Step 06 | Gene set enrichment analysis |
| [07_aggregate.Rmd](07_aggregate.Rmd) | Step 07 | Aggregate results + status tile plot |
